...
\item Chaque utilisateur fait une demande de certificat en générant un \textit{request certificate} envoyé au CA. 
\item Le CA contrôle le \textit{request certificate} et génère un certificat signé pour l'utilisateur.
\end{itemize}
...
voici les couches com avec quelques liens\\
* CORBA:
- Mico: http://www.mico.org (la version qui implémente les services
de sécurité s'appelle micosec)\\
- TAO:
http://www.dre.vanderbilt.edu/~schmidt/DOC\_ROOT/TAO/docs/Security/index.html
