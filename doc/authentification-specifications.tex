...
L'objectif de ce document est de décrire les besoins en terme de sécurité pour la future version 3 de DIET\footnote{
DIET (\textit{Distributed Interactive Engineering Toolbox}) est un middleware con\c{c}u pour le calcul à haute performance
dans des environnements hétérogènes et distribués (workstations, clusters, grids, clouds etc). Disponible à: http://graal.ens-lyon.fr/DIET/}. Plus précisement, nous allons mettre
