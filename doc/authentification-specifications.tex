...
\begin{SFrevtable}
  ...
  \SFrevitem{10/08/2011}{Correction de quelques typos}{Benjamin DEPARDON}
\end{SFrevtable}
}
...
\item \textbf{ \'Etat authentifié }: l'identité de l'utilisateur est reconnue par le système. La session authentifiée a une durée de vie liée au mode de connexion choisi 
		par l'utilisateur et pendant cette période, il a accès aux services autorisés aux groupes auxquels il appartient.
...
Il est donc possible de pointer sur n'importe quel n{\oe}ud de la hiérarchie, ce qui rend plus flexible l'infrastructure 
