...
de sécurité lorsque qu'un noeud malveillant s'introduit dans le réseau ou encore lorsqu'un utilisateur à accès à des
...
Il existe deux principaux types de chiffrement: sysmtrique et asymétrique. L'inconvénient du chiffrement sysmétrique est l'existance 
...
et le destinataire utilise la même clé. Aussi, les systèmes sysmétriques restent plus lents. C'est pour cette raison qu'il est intéressant
